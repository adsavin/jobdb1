...
if (!$full) {
    ...
    <div id="wizardButton" style="text-align:left" class="controlPanel marginBottom">
        <?php
        echo SHtml::ajaxLink(
                SHtml::image($this->module->getIconsPath() . '/admin.png', Helper::translate('srbac', 'Manage AuthItem'), array('class' => 'icon',
        ...
        <?php
        echo SHtml::ajaxLink(
                SHtml::image($this->module->getIconsPath() . '/wizard.png', Helper::translate('srbac', 'Autocreate Auth Items'), array('class' => 'icon',
        ...
        <?php
        echo SHtml::ajaxLink(
                SHtml::image($this->module->getIconsPath() . '/allow.png', Helper::translate('srbac', 'Edit always allowed list'), array('class' => 'icon',
        ...
        <?php
        echo SHtml::ajaxLink(
                SHtml::image($this->module->getIconsPath() . '/eraser.png', Helper::translate('srbac', 'Clear obsolete authItems'), array('class' => 'icon',
