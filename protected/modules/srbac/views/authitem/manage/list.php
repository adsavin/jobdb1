    ...
    <div id="messageUpd"
         ...
         >
             ...
             Yii::app()->clientScript->registerScript(
                     'myHideEffect', '$("#messageUpd").animate({opacity: 0}, 2000).fadeOut(500);', CClientScript::POS_READY
             );
             ?>
    </div>
         <?php endif; ?>
...
<?php
echo SHtml::ajaxLink(
        SHtml::image($this->module->getIconsPath() . '/create.png', Helper::translate('srbac', 'Create'), array('border' => 0,
            'class' => 'icon', 'title' => Helper::translate('srbac', 'Create'),
            'border' => 0
                )
        ) . Helper::translate('srbac', 'Create'), array('create'), array(
    'type' => 'POST',
    'update' => '#preview',
    'beforeSend' => 'function(){
...
?>
    ...
    <div style="margin: 0px">
        ...
        ?>
        <?php
        echo SHtml::imageButton($this->module->getIconsPath() . '/preview.png', array(
            'border' => 0,
...
<table class="srbacDataGrid">
    <tr>
        ...
        <th>
<?php
echo SHtml::dropDownList('selectedType', Yii::app()->user->getState("selectedType"), AuthItem::$TYPES, array(
...
?>
        ...
        <tr class="<?php echo $n % 2 ? 'even' : 'odd'; ?>">
            <td><?php
                echo SHtml::ajaxLink($model->name, array('show', 'id' => $model->name), array('type' => 'POST', 'update' => '#preview',
                    'beforeSend' => 'function(){
                      $("#preview").addClass("srbacLoading");
                  }',
                    'complete' => 'function(){
            ...
            <td>
                <?php
                echo SHtml::ajaxLink(
                        SHtml::image($this->module->getIconsPath() . '/update.png', Helper::translate('srbac', 'Update'), array('border' => 0, 'title' => Helper::translate('srbac', 'Update'))), array('update', 'id' => $model->name), array(
                    'type' => 'POST',
                    'update' => '#preview',
                    'beforeSend' => 'function(){
                      $("#preview").addClass("srbacLoading");
                ...
                <?php if ($model->name != Helper::findModule('srbac')->superUser) {
                    ...
                    echo SHtml::ajaxLink(
                            SHtml::image($this->module->getIconsPath() . '/delete.png'
                                    , Helper::translate('srbac', 'Delete'), array('border' => 0, 'title' => Helper::translate('srbac', 'Delete'))), array('confirm', 'id' => $model->name), array(
                        'type' => 'POST',
                        'update' => '#preview',
                        'beforeSend' => 'function(){
                      $("#preview").addClass("srbacLoading");
