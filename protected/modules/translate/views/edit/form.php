...
<div class="form">
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model->source, 'message', array("class" => "span5", 'disabled' => 'disabled')); ?>
    </div>

    <div class="row">
        <?php echo $form->labelEx($model, 'translation'); ?>
        <?php // echo $form->textArea($model, 'translation', array('rows' => 2, 'cols' => 80)); ?>
        <?php echo $form->textField($model, 'translation', array("class" => "span5")); ?>
