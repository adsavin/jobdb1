    ...
    public function actionCreate() {
        ...
        if (isset($_POST['User'])) {
            ...
            try {
                ...
                $assignment->itemname = $model->user_role;
...
//                $this->redirect(array("admin"));
        ...
        $userRoles = Items::model()->findAll("type = :type", array(
            ":type" => 2,
        ));
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['User'])) {
            ...
            try {
                ...
                $assignment = Assignments::model()->find("userid =: user_id", array("user_id" => $model->id));
                $assignment->itemname = $model->user_role;
                if (!$assignment->save()) {
                    throw new Exception(Yii::app()->params["cannotSave"]);
                }
