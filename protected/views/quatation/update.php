...
$this->menu = array(
    ...
    //array('label' => Yii::t('app', 'Create') . ' ' . Quatation::label(), 'icon' => 'plus', 'url' => array('create')),
...
<fieldset>
    <legend><?php echo Yii::t('app', 'Update') . ' ' . Quatation::label(); ?> <?php echo CHtml::encode($model) ?></legend>
